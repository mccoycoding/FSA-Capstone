...
export default function CartCard({ product, handleRemoveFromCart, updateQuantity }) {
  ...
  const increaseQuantity = () => {
    ...
    // Call the updateQuantity function to update the quantity in countedCart
    ...
    return (
        <div className="card" style={{width: "18rem"}}>
            <div className="card-body">
                ...
                <p className="card-text">${(product.price * quantity).toFixed(2)}</p>
